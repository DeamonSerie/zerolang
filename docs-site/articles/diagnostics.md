...
- `BOR001`: lexical borrow conflicts, with JSON `borrowTrace.activeBorrows` entries naming the borrowed root, path, kind, live binding, declaration range when known, and repair shape
